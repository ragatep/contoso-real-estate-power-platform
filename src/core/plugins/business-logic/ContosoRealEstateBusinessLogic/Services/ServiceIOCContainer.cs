...
{
    private readonly Dictionary<(Type, string), Type> _serviceRegistry = new();
    private readonly Dictionary<(Type, string), object> _instanceRegistry = new();
    private readonly Dictionary<(Type, string), Func<object>> _factoryRegistry = new();
