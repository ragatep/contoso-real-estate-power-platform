...
public abstract class BusinessLogicPluginBase : PluginBase, IPlugin
{
    ...
    /// </exception>
    protected static void ValidateCustomApiExectionContext(ILocalPluginContext localPluginContext, string messageName)
    {
    ...
    /// </exception>
    protected static void ValidatePluginExecutionContext(ILocalPluginContext localPluginContext, MessageNameEnum messageName, StageEnum stage, string logicalName)
    {
        if (localPluginContext == null)
        {
            throw new ArgumentNullException(nameof(localPluginContext));
    ...
    protected static bool UsePowerFxPlugins(ILocalPluginContext localPluginContext)
    {
